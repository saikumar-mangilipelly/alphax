        ...
        <div className='col-lg-8 col-md-8 mx-auto col-11 col-xl-4'>
          <div className='card signupcard'>
            <form onSubmit={handleSubmit(onsubmit)}>
              ...
              <input type="password" id='pass' placeholder='Enter your Password' className='edplace form-control' {...register("password",{required:true})}/>
              ...
              <input type="password" id='cfpass' className='form-control edplace' placeholder='Confirm your Password' {...register("cpassword",{required:true})}/>
